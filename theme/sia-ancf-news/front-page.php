    ...
    <section class="sia-lead-layout" aria-label="<?php esc_attr_e('Top stories', 'sia-ancf-news'); ?>">
      <article class="sia-lead-story">
        ...
        <div class="sia-lead-story__body">
          ...
          <?php endif; ?>
          <h1 style="font-size:clamp(1.35rem,1.8vw,2.05rem);line-height:1.18;letter-spacing:0;text-wrap:balance"><a href="<?php echo esc_url(get_permalink($lead_id)); ?>"><?php echo esc_html(get_the_title($lead_id)); ?></a></h1>
